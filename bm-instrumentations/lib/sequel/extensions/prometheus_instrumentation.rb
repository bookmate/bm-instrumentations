...
module Sequel
  module Extensions
    # Is a Sequel extension that instrument a database queries and writes metrics into Prometheus
    #
    ...
    module PrometheusInstrumentation
      ...
      def log_connection_yield(sql, conn, args = nil)
        ...
        begin
          ...
          metrics_collection.record_query(db: db, query: query, stopwatch: stopwatch, status: 'fail')
          raise
        end
      end
